  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        <img src={currentUser.avatar} alt="profil" className='rounded-full h-24 w-24 object-cover cursor-pointer self-center mt-2'/>
        <input type="text" placeholder="Korisnicko ime" id='username' className='border p-3 rounded-lg' />
